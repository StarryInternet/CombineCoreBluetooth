...
extension Peripheral {
  public static func unimplemented(
    ...
    readValueForCharacteristic: @escaping (CBCharacteristic) -> AnyPublisher<Data?, Error> = Internal._unimplemented("readValueForCharacteristic"),
    maximumWriteValueLength: @escaping (CBCharacteristicWriteType) -> Int = Internal._unimplemented("maximumWriteValueLength"),
    writeValueForCharacteristic: @escaping (Data, CBCharacteristic, CBCharacteristicWriteType) -> AnyPublisher<Void, Error> = Internal._unimplemented("writeValueForCharacteristic"),
    setNotifyValue: @escaping (Bool, CBCharacteristic) -> AnyPublisher<Void, Error> = Internal._unimplemented("setNotifyValue"),
    ...
    readValueForDescriptor: @escaping (CBDescriptor) -> AnyPublisher<Any?, Error> = Internal._unimplemented("readValueForDescriptor"),
    writeValueForDescriptor: @escaping (Data, CBDescriptor) -> AnyPublisher<Void, Error> = Internal._unimplemented("writeValueForDescriptor"),
    openL2CAPChannel: @escaping (CBL2CAPPSM) -> AnyPublisher<L2CAPChannel, Error> = Internal._unimplemented("openL2CAPChannel"),
    listenForUpdatesToCharacteristic: @escaping (CBCharacteristic) -> AnyPublisher<Data?, Error> = Internal._unimplemented("listenForUpdatesToCharacteristic"),
